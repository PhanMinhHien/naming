...
function renderVendorList(t) {
    ...
    0 === e.length
        ...
        : (e.forEach((e) => {
              ...
              let a = e.replace(/\s+/g, "-");
              (t.textContent = a),
                  reverseVendorMap.set(a.toLowerCase(), e),
...
vendorInput.addEventListener("input", function () {
    ...
    vendorInput.addEventListener("blur", () => {
        setTimeout(() => {
            var e = vendorInput.value,
                e = findAndRenderVendor(e);
...
function checkAndGenerate() {
    var e = document.getElementById("languageInput"),
        ...
        a = document.getElementById("bannerProofSection"),
        n = document.getElementById("bannerSize"),
        o = document.getElementById("typeBanner"),
        l = document.getElementById("bannerPositonSection"),
        i = ["vendor", "campaignName", "programCode", "customDate", "idTicket"].every((e) => {
            e = document.getElementById(e);
            return e && "" !== e.value.trim();
        }),
        r = e.value.trim().toUpperCase(),
        s = r && languageOptions.includes(r),
        o = o?.value.trim(),
        t = t?.value.trim();
    (a.style.display = "" !== o && "" !== t && s ? "block" : "none"),
        n && "" !== n.value.trim() && s ? (l.style.display = "block") : (l.style.display = "none"),
        i ? (e.classList.remove("disabled"), (e.disabled = !1), r && languageOptions.includes(r) && 1 === (a = salesOrgMap[r] || []).length && (renderTableByLanguageAndCode(r, a[0]), generateNames(r, a[0]))) : (e.classList.add("disabled"), (e.disabled = !0));
}
document.addEventListener("DOMContentLoaded", function () {
    ...
    let e = document.getElementById("outputHTML"),
        t =
...
function generatePositionBannerName(e, t) {
    var a = document.getElementById("vendor").value.toLowerCase(),
        ...
        i = document.getElementById("bannerSize").value.trim(),
        r = document.getElementById("customDate").value,
        r = r ? new Date(r) : new Date(),
        r = r.getFullYear().toString().slice(-2) + "CW" + getWeekNumber(r),
        t = (t || (salesOrgMap[e] && salesOrgMap[e][0]) || "0000") + `_${a}_${r}_${e}${n}_${o}_${l}_` + i;
...
function autoParseCampaignInfo() {
    var e,
        { langCode: t, vendor: a, campaign: n } = parseCampaignInfo(document.getElementById("campaignName").value);
    n && (document.getElementById("campaignName").value = n),
        a && (document.getElementById("vendor").value = a),
        t && (((e = document.getElementById("languageInput")).value = t), e.dispatchEvent(new Event("input", { bubbles: !0 }))),
        console.log("🎯 Auto parsed:", { langCode: t, vendor: a, campaign: n });
}
...
function findBestMatchingVendor(e) {
    ...
    var t,
        ...
        o = 0 < e.length ? e[0].original : "";
    renderVendorList(o);
    for ([t, a] of reverseVendorMap.entries()) if (a === o) return t;
...
function parseCampaignInfo(e) {
    var e = e.split("-").slice(1).join("-").split("*")[0].trim(),
        e = (console.log("mainPart", e), e.split(/\s+/)),
...
function generateNames(e, t) {
    ...
    let o = document.getElementById("vendor").value,
        l = document.getElementById("campaignName").value,
        i = document.getElementById("languageInput").value,
        r = document.getElementById("campaignID").value.trim(),
    ...
    n.forEach((t) => {
        ...
        console.log("✅ Final info:", { campaign: l, vendor: o, langCode: i }),
        generateProofName(i, n[0]),
        generatePositionBannerName(i, n[0]);
}
...
let inputEl = document.getElementById("inputHTML"),
    outputEl = document.getElementById("outputHTML");
function convertUnicodeToHTMLEntities(e) {
    var t;
    let a = "";
    for (t of e.replace(/[\n\r]/g, "")) a += `&#${t.codePointAt(0)};`;
    return a;
}
