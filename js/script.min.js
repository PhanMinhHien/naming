...
function checkAndGenerate() {
    var e = document.getElementById("languageInput"),
        ...
        i = document.getElementById("typeBanner"),
        r = document.getElementById("bannerPositonSection"),
        i = i?.value.trim(),
        t = t?.value.trim(),
        a = a?.value.trim(),
    ...
    (n.style.display = "" !== i && "" !== t && d ? "block" : "none"),
        (r.style.display = l && "" !== l.value.trim() && d ? "block" : "none"),
