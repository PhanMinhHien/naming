...
for (let o in dataMap)
  for (let n in dataMap[o]) {
    let e = dataMap[o][n].ctaText,
      t = e.toLowerCase(),
      a = t.charAt(0).toUpperCase() + t.slice(1);
    dataMap[o][n].ctaText = a;
  }
...
function generateNames(e, t) {
  ...
  let n,
    o =
      ...
      n.date &&
        ...
        ((d = document.getElementById("customDate")).value = a),
        (a = new Event("change")),
        d.dispatchEvent(a)),
  ...
  var d = document.getElementById("customDate").value,
    a = d ? new Date(d) : new Date(),
    d = a.getFullYear().toString().slice(-2);
  let c =
      "" +
      String(a.getMonth() + 1).padStart(2, "0") +
      String(a.getDate()).padStart(2, "0"),
    m = d + "CW" + getWeekNumber(a),
  ...
  d.forEach((t) => {
    ...
    generateProofName(r, d[0]),
    generatePositionBannerName(r, d[0]);
}
