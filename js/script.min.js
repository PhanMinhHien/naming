...
function autoParseCampaignInfo() {
  var e,
    t,
    a,
    n = document.getElementById("campaignName").value;
  n.startsWith("Today:")
    ? ((e = parseTodayInfo(n)).campaign &&
      ...
      e.langCode &&
        (((t = document.getElementById("languageInput")).value = e.langCode),
        t.dispatchEvent(new Event("input", { bubbles: !0 }))),
      e.programCode &&
        (document.getElementById("programCode").value = e.programCode),
      e.date &&
        ((t = document.getElementById("customDate")),
        (e = new Date(e.date).toISOString().split("T")[0]),
        (t.value = e),
        (e = new Event("input")),
        t.dispatchEvent(e)),
      (t = document.getElementById("todayName")) && (t.value = n))
    : (({
        langCode: e,
        vendor: t,
        campaign: n,
      ...
      n && (document.getElementById("campaignName").value = n),
      a && (document.getElementById("campaignID").value = a),
      t && (document.getElementById("vendor").value = t),
      e &&
        (((n = document.getElementById("languageInput")).value = e),
...
function parseCampaignInfo(e) {
  ...
  (a = a
    ...
    .replace(/\s?Q(\d)/i, "Q$1")
    .trim()).includes("5710 ALSO Finland Oy") &&
    (a = a.replace("5710 ALSO Finland Oy", "5710")),
    console.log("Main part after cleaning:", a);
  var e = a.split(/\s+/),
    n = e.find((e) => /^\d{4}$/.test(e)),
    o = getLangFromSalesOrg(n),
    n = e.indexOf(n),
    l = findQuarterToken(e);
  let r = "",
    i = "",
    s =
      (-1 !== n &&
        -1 !== l &&
        n < l &&
        ((n = e.slice(n + 1, l).join(" ")), (r = findBestMatchingVendor(n))),
      r &&
        ((n = new RegExp(`\\b${r}\\b`, "i")),
        console.log("vendorPattern", n),
        (a = a
          .replace(n, "")
          .replace(/\s{2,}/g, " ")
          .trim())),
      -1 !== l && ((n = e.slice(l + 1)), (i = n.join(" "))),
      r.toLowerCase());
  return (
    (i = i
      .split(/\s+/)
