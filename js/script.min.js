...
function renderTableByLanguageAndCode(e, t) {
    console.log("Render bảng cho", e, t);
}
function generateNames(e, t) {
    console.log("Render tên cho", e, t);
}
...
function checkAndGenerate() {
    var e = document.getElementById("languageInput"),
        t = (document.getElementById("idTicket"), document.getElementById("bannerProofSection")),
        a = document.getElementById("bannerSize"),
        n = document.getElementById("typeBanner"),
        o = document.getElementById("bannerPositonSection"),
        l = ["vendor", "campaignName", "campaignID", "programCode", "customDate"].every((e) => {
            e = document.getElementById(e);
            return e && "" !== e.value.trim();
        }),
        i = e.value.trim().toUpperCase(),
        r = i && languageOptions.includes(i);
    n && "" !== n.value.trim() && r ? (t.style.display = "block") : (t.style.display = "none"),
        a && "" !== a.value.trim() && r ? (o.style.display = "block") : (o.style.display = "none"),
        l ? (e.classList.remove("disabled"), (e.disabled = !1), i && languageOptions.includes(i) && 1 === (n = salesOrgMap[i] || []).length && (renderTableByLanguageAndCode(i, n[0]), generateNames(i, n[0]))) : (e.classList.add("disabled"), (e.disabled = !0));
}
function generateProofName(e, t) {
    var a = document.getElementById("vendor").value.trim().replace(/\s+/g, ""),
...
function generatePositionBannerName(e, t) {
    var a = document.getElementById("vendor").value.toLowerCase(),
        n = document.getElementById("campaignName").value.trim().replace(/\s+/g, ""),
...
function generateNames(o, e) {
    let l = document.getElementById("vendor").value.toLowerCase(),
        i = document.getElementById("campaignName").value.replace(/\s+/g, ""),
        r = document.getElementById("campaignID").value.trim(),
        s = document.getElementById("programCode").value;
    var t = document.getElementById("customDate").value,
        t = t ? new Date(t) : new Date(),
        a = t.getFullYear().toString().slice(-2);
    let d = "" + String(t.getMonth() + 1).padStart(2, "0") + String(t.getDate()).padStart(2, "0"),
        c = a + "CW" + getWeekNumber(t),
        m = document.getElementById("tableBodyName");
    (m.innerHTML = ""),
        (e ? [e] : salesOrgMap[o] || []).forEach((t) => {
        ...
        generateProofName(o, e),
        generatePositionBannerName(o, e);
}
